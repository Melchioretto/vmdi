...
% -----------------------------------------------------------------
% Subseções a redigir em sequência:
%   1.1.3 Cadeia produtiva da fábrica de fios
%     base: docs/dissertacao/08_contexto_industrial.md
%   1.1.4 Operação contínua e impacto dos rompimentos
%   1.1.5 Multiplicidade de causas e dificuldade de diagnóstico
% -----------------------------------------------------------------
