...
% Data: 13/08/2024 v1.0.2 alterado para citação (Autor, Ano) ao invés de (AUTOR, Ano) conforme ABNT NBR 10520:2023; Removido < > dos links das referências.
% ------------------------------------------------------------------------
% ------------------------------------------------------------------------
...
% -----------------------------------------------------------------
\titulo{Ferramenta Híbrida de Apoio à Decisão para Inferência da Provável Origem de Rompimentos em uma Fábrica de Fios}%

\autor{Vitor {}Melchioretto}%
\orientador{Nome do Orientador {}Sobrenome}% TODO: preencher
\coorientador{Nome do Coorientador {}Sobrenome}% TODO: preencher ou comentar se não houver
...
\include{Textuais/Capitulo01}	% Introdução
\include{Textuais/Capitulo02}	% Fundamentação teórica
\include{Textuais/Capitulo03}	% Metodologia
\include{Textuais/Capitulo04}	% Desenvolvimento da ferramenta
\include{Textuais/Capitulo05}	% Resultados e discussão
\include{Textuais/Capitulo06}	% Conclusão
...
\bibliography{abntex2-ref_UDESC_2024}	% Elemento Obrigatório
